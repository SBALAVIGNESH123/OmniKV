...
lazy_static! {
    pub static ref WRITES_TOTAL: IntCounter =
        register_int_counter!("omnikv_writes_total", "Total number of write operations").expect("OmniKV metric registration failed at startup: duplicate or invalid metric name");
    pub static ref READS_TOTAL: IntCounter =
        register_int_counter!("omnikv_reads_total", "Total number of read operations").expect("OmniKV metric registration failed at startup: duplicate or invalid metric name");
    ...
    pub static ref SSTABLE_COUNT: IntGauge =
        register_int_gauge!("omnikv_sstable_count", "Total number of SSTables (L0 + L1)").expect("OmniKV metric registration failed at startup: duplicate or invalid metric name");
    ...
    pub static ref UPTIME_SECONDS: IntGauge =
        register_int_gauge!("omnikv_uptime_seconds", "Server uptime in seconds").expect("OmniKV metric registration failed at startup: duplicate or invalid metric name");
    pub static ref COMMIT_RATE: IntCounter =
        register_int_counter!("omnikv_commits_total", "Total number of committed batches").expect("OmniKV metric registration failed at startup: duplicate or invalid metric name");
}
